...
You can find commonly needed information by navigating to the command menu <kbd>Ctrl</kbd> <kbd>Shift</kbd> <kbd>P</kbd> and searching for `Aderyn: Welcome on board` 
...
2. **Can I use Aderyn on a custom project structure (not Foundry or Hardhat)?**
   ...
   If the project's framework config file is nested in some directory or is using a custom build pipeline, please create an aderyn.toml by typing Cmd/Ctrl + Shift + P and searchif for "Aderyn: initialize config file" 
...
3. **How do I open the Welcome Page?**
   ...
   To open the welcome page, press: <kbd>Ctrl</kbd> <kbd>Shift</kbd> <kbd>P</kbd> and search for "Aderyn: Welcome on board" 
