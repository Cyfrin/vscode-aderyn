...
> In settings, set the gallery service URL to `http://marketplace.visualstudio.com/_apis/public/gallery` and the gallery item URL to `https://marketplace.visualstudio.com/items`
