...
<div class="m-4 mt-8 rounded-lg p-6">
    ...
    <div class="mb-8">
        <p class="font-light mt-4 text-gray-600 dark:text-gray-300">
            Remember, to press
            <kbd
                class="px-2 py-1 text-xs font-semibold bg-gray-100 dark:bg-gray-700 rounded"
                >Cmd</kbd
            >
            /
            <kbd
                    ...
                    {#each Object.entries(commandGuide) as [command, purpose], i}
                        <tr
                            class="{i % 2 === 0
                                ...
                                : 'bg-gray-50 dark:bg-gray-800'} hover:bg-blue-50 dark:hover:bg-gray-600 transition-colors"
                        >
                            <td
                                class="py-3 px-4 border-b border-gray-200 dark:border-gray-600 font-medium text-blue-600 dark:text-blue-400"
                            >
                                Aderyn: {command}
                            </td>
                            <td
